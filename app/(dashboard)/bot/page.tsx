  ...
  const predictLeadQuality = async (data: LeadData) => {
    ...
    try {
      ...
      try {
        ...
        console.error("No se pudo guardar el lead:", saveError)
      }
      ...
      <header className="flex flex-col justify-between gap-3 md:flex-row md:items-center">
        <div>
          ...
          <p className="mt-1 max-w-2xl text-sm text-slate-300">
            Conversación tipo WhatsApp que captura datos clave del lead y los califica con IA.
          </p>
        </div>
          ...
          <CardHeader className="border-b border-slate-800 bg-slate-900/80">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">Paso {stepNumber} de 5</p>
              </div>
            </div>
          </CardHeader>
          ...
          <CardContent className="flex flex-1 flex-col bg-gradient-to-b from-slate-900/80 to-slate-950/90 p-4">
            ...
            {showServiceSelect && (
              <div className="mt-4 rounded-2xl border border-slate-800 bg-slate-900/80 p-3">
                <p className="mb-2 text-[11px] text-slate-300">Selecciona el servicio:</p>
              ...
              <form onSubmit={handleSubmit} className="mt-4 border-t border-slate-800 pt-3">
                <div className="flex gap-2">
                  <Input
                    ...
                    disabled={isLoading}
                    className="flex-1 border-slate-700 bg-slate-900/80 text-sm text-slate-50"
                  />
                  <Button
                    type="submit"
                    size="icon"
          ...
          <CardContent className="space-y-4 pt-4 text-sm text-slate-50">
            <div className="grid grid-cols-1 gap-3 rounded-2xl bg-slate-950/40 p-3 ring-1 ring-slate-800/80 md:grid-cols-2">
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="text-[11px] uppercase text-slate-400">Nombre</p>
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="text-[11px] uppercase text-slate-400">Ciudad</p>
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="text-[11px] uppercase text-slate-400">Presupuesto</p>
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="text-[11px] uppercase text-slate-400">Urgencia</p>
                  <p className="text-sm font-medium">
                    {leadData.urgency ? `${leadData.urgency} / 5` : "Sin definir"}
                  </p>
                </div>
              </div>
            ...
            {/* MENSAJE FINAL — SIN TIBIO, SIN LABEL */}
            <p className="pt-1 text-xs text-slate-400">
              Completa la conversación para ver la clasificación del lead.
            </p>
